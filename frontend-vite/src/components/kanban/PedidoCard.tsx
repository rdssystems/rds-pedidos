...
export const PedidoCard: React.FC<PedidoCardProps> = ({ pedido, onVerPedido, onAvançar, draggable, onDragStart }) => {
    ...
    return (
        <div
            ...
            className={`p-4 mb-4 rounded-xl shadow-sm border transaction-all duration-300 bg-white hover:shadow-md ${draggable ? 'cursor-grab active:cursor-grabbing' : ''} ${isDelayed ? 'border-red-200 ring-2 ring-red-50 bg-red-50/10' : 'border-white'}`}
        >

    ...
    return (
        <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <header className="text-center space-y-3 max-w-3xl mx-auto">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-red-50 text-red-600 rounded-full text-[10px] font-black uppercase tracking-widest italic border border-red-100 shadow-sm transition-all hover:scale-105">
                    <Star size={14} fill="currentColor" /> Escolha o seu plano
                </div>
                <h1 className="text-4xl md:text-5xl font-black text-gray-900 italic uppercase tracking-tighter leading-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 max-w-5xl mx-auto">
                {plans.map((plan) => (
                    <div
                        key={plan.id}
                        className={`relative bg-white rounded-2xl p-10 flex flex-col transition-all duration-500 hover:shadow-2xl ${plan.popular
                    ...
                    >
                        ...
                        <div className="flex items-baseline gap-1 mb-8">
                            ...
                            <span className="text-5xl md:text-6xl font-black text-gray-900 italic tracking-tighter">{plan.price}</span>
                            <span className="text-gray-400 font-black italic uppercase text-[12px] tracking-widest">/mês</span>
                        </div>

                        <div className="space-y-4 flex-1 mb-10 border-t border-gray-100 pt-8">
            ...
            <footer className="grid grid-cols-1 md:grid-cols-4 gap-8 pt-24 mt-12 border-t border-gray-100">
                <div className="flex flex-col items-center text-center gap-4 p-8 group bg-white/50 rounded-xl border border-transparent hover:border-gray-100 hover:bg-white transition-all duration-500 hover:shadow-xl">
                    <div className="w-16 h-16 bg-gray-50 rounded-[1.5rem] flex items-center justify-center text-gray-900 group-hover:bg-primary/10 group-hover:text-primary transition-all duration-500 shadow-sm">
                        <ShoppingBag size={32} />
                    </div>
                    <div>
                        <h4 className="font-black uppercase tracking-tight italic text-gray-900">Integração iFood</h4>
                        <p className="text-[10px] text-gray-400 font-bold uppercase italic tracking-wider mt-1">Sincronia Total</p>
                    </div>
                </div>
                <div className="flex flex-col items-center text-center gap-4 p-8 group bg-white/50 rounded-xl border border-transparent hover:border-gray-100 hover:bg-white transition-all duration-500 hover:shadow-xl">
                    <div className="w-16 h-16 bg-gray-50 rounded-[1.5rem] flex items-center justify-center text-gray-900 group-hover:bg-green-50 group-hover:text-green-600 transition-all duration-500 shadow-sm">
                        <MessageCircle size={32} />
                    </div>
                    <div>
                        <h4 className="font-black uppercase tracking-tight italic text-gray-900">WhatsApp Bot</h4>
                        <p className="text-[10px] text-gray-400 font-bold uppercase italic tracking-wider mt-1">Automação IA</p>
                    </div>
                </div>
                <div className="flex flex-col items-center text-center gap-4 p-8 group bg-white/50 rounded-xl border border-transparent hover:border-gray-100 hover:bg-white transition-all duration-500 hover:shadow-xl">
                    <div className="w-16 h-16 bg-gray-50 rounded-[1.5rem] flex items-center justify-center text-gray-900 group-hover:bg-blue-50 group-hover:text-blue-600 transition-all duration-500 shadow-sm">
                        <BarChart3 size={32} />
                    </div>
                    <div>
                        <h4 className="font-black uppercase tracking-tight italic text-gray-900">Dashboard BI</h4>
                        <p className="text-[10px] text-gray-400 font-bold uppercase italic tracking-wider mt-1">Dados Estratégicos</p>
                    </div>
                </div>
                <div className="flex flex-col items-center text-center gap-4 p-8 group bg-white/50 rounded-xl border border-transparent hover:border-gray-100 hover:bg-white transition-all duration-500 hover:shadow-xl">
                    <div className="w-16 h-16 bg-gray-50 rounded-[1.5rem] flex items-center justify-center text-gray-900 group-hover:bg-amber-50 group-hover:text-amber-600 transition-all duration-500 shadow-sm">
                        <ShieldCheck size={32} />
                    </div>
                    <div>
                        <h4 className="font-black uppercase tracking-tight italic text-gray-900">Segurança</h4>
                        <p className="text-[10px] text-gray-400 font-bold uppercase italic tracking-wider mt-1">Check de Dados</p>
                    </div>
                </div>
            </footer>
        </div>

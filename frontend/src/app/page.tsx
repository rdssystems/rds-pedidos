    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-center p-24 bg-secondary">
            <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
                <h1 dir="ltr" className="text-4xl font-bold text-primary mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="p-6 border rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <button className="mt-4 px-4 py-2 bg-primary text-white rounded-lg w-full font-medium">
                        Ver Cardápio
                    </button>
                </div>
            </div>
            ...
            <div className="mt-12 p-4 bg-gray-100 rounded-lg text-center">
                <p className="text-sm text-gray-500">
                    Esta é uma versão inicial configurada com Next.js 15 + Tailwind 4.
                </p>
            </div>
        </main>
    );

                        ...
                        <div className="p-10 space-y-8">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className={`p-4 rounded-2xl ${status === 'connected' ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-400'}`}>
                                        <Smartphone size={32} />
                                    </div>
                                    <div>
                            ...
                            {status === 'disconnected' && (
                                <div className="space-y-6">
                                    ...
                                    <button
                                        ...
                                        className="w-full py-5 bg-primary text-white rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-1 transition-all flex items-center justify-center gap-3"
                                    >
                                        <QrCode size={24} />
                            ...
                            {status === 'connecting' && (
                                <div className="flex flex-col items-center space-y-8 py-4 animate-in fade-in zoom-in duration-500">
                                    ...
                                    <button
                                        ...
                                        className="mt-4 px-8 py-3 border-2 border-red-100 text-red-500 rounded-2xl font-black uppercase italic tracking-widest text-xs hover:bg-red-50 hover:border-red-200 transition-all shadow-sm"
                                    >
                            ...
                            {status === 'connected' && (
                                <div className="space-y-8">
                                    ...
                                    <button
                                        ...
                                        className="w-full py-5 border-2 border-red-100 text-red-500 rounded-2xl font-black uppercase tracking-widest hover:bg-red-50 transition-all flex items-center justify-center gap-3"
                                    >
                                        <XCircle size={24} />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="flex gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-gray-400 leading-relaxed font-medium">Notificamos o cliente assim que você recebe o pedido.</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="bg-white/10 p-3 rounded-xl shrink-0 h-fit">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-gray-400 leading-relaxed font-medium">Mantenha o cliente informado sobre o preparo e entrega.</p>
                                </div>
                            </div>
                        </div>
                    </div>

...
import { Bot, Send, X, Minimize2, Maximize2, Sparkles, TrendingUp, AlertCircle } from 'lucide-react';
...
export default function AIFinanceChat() {
    ...
    // We will initialize messages depending on whether user is available
    ...
    // Se não for dono da loja, nem renderiza o chat flutuante

...
interface AddonGroupModalProps {
    ...
    storeSlug?: string; // If needed for creation context
}
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const payload: any = {
                ...
                opcoes: opcoes.filter(o => o.nome.trim() !== '') // Filter empties
            };

            const activeStoreId = localStorage.getItem('activeStoreId');
            if (activeStoreId) {
                payload.loja = parseInt(activeStoreId);
            }
            ...
            <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-2 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                                ...
                                {opcoes.length === 0 && (
                                    <p className="text-center text-gray-400 text-sm py-4 italic">Nenhuma opção adicionada.</p>
                                )}
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-6 border-t border-gray-100 bg-gray-50/50 flex justify-end gap-3">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="px-6 py-2.5 rounded-xl font-bold bg-primary text-white shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-0.5 transition-all flex items-center gap-2 disabled:opacity-50 disabled:translate-y-0"
                    >
                        {loading ? 'Salvando...' : (
                            <>
